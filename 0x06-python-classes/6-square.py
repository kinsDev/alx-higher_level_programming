...
class Square:
    ...
    def position(self, value):
        ...
        Args:
            value (tuple[int, int]): The new position of the square.
    ...
    def my_print(self):
        ...
        # Print empty lines for the vertical position offset
        [print("") for _ in range(self.__position[1])]

        # Print the square rows with horizontal position offset and #
